...
if attention_or_mlp == "attention":
  ...
  tiles = {
    ...
    64: {"TileSizes" : [64, 128, 32, 32, 64, 32], "SoftmaxRowTile": 1, "MaxTBsPerSM": 3, "Best-Policy": "Tile-Sync",
      ...
      20480: {"split_ks":  [12,3]},
      25600: {"split_ks":  [12,3]}},
    32: {"TileSizes" : [64, 128, 32, 32, 64, 32], "split_ks": [4,1], "MaxTBsPerSM": 3,
      6144: {"split_ks":   [4,1]},
      8192: {"split_ks":   [4,1]},
      10240: {"split_ks":  [4,1]},
      12288: {"split_ks":  [4,1]},
      ...
      20480: {"split_ks":  [4,1]},
      25600: {"split_ks":  [4,1]}},
    16: {"TileSizes" : [64, 128, 32, 32, 64, 32], "split_ks": [4,1], "MaxTBsPerSM": 3,
      6144: {"split_ks":   [4,1]},
      8192: {"split_ks":   [4,1]},
      10240: {"split_ks":  [4,1]},
      12288: {"split_ks":  [4,1]},
      ...
      20480: {"split_ks":  [4,1]},
      25600: {"split_ks":  [4,1]}},
    8: {"TileSizes" : [64, 128, 32, 32, 64, 32], "split_ks": [4, 1], "MaxTBsPerSM": 3,
      6144: {"split_ks":   [4,1]},
      8192: {"split_ks":   [4,1]},
      10240: {"split_ks":  [4,1]},
      12288: {"split_ks":  [4,1]},
      ...
      20480: {"split_ks":  [4,1]},
      25600: {"split_ks":  [4,1]}},
    4: {"TileSizes" : [64, 128, 32, 32, 64, 32], "split_ks": [4, 1], "MaxTBsPerSM": 3,
      6144: {"split_ks":   [4,1]},
      8192: {"split_ks":   [4,1]},
      10240: {"split_ks":  [4,1]},
      12288: {"split_ks":  [4,1]},
      ...
      20480: {"split_ks":  [4,1]},
      25600: {"split_ks":  [4,1]}},
    2: {"TileSizes" : [64, 128, 32, 32, 64, 32], "split_ks": [4,1], "MaxTBsPerSM": 3,
      6144: {"split_ks":   [4,1]},
      8192: {"split_ks":   [4,1]},
      10240: {"split_ks":  [4,1]},
      12288: {"split_ks":  [4,1]},
      ...
      20480: {"split_ks":  [4,1]},
      25600: {"split_ks":  [4,1]}},
    1: {"TileSizes" : [64, 128, 32, 32, 64, 32], "split_ks": [4,1], "MaxTBsPerSM": 3,
      6144: {"split_ks":   [4,1]},
      8192: {"split_ks":   [4,1]},
      10240: {"split_ks":  [4,1]},
      12288: {"split_ks":  [4,1]},
  ...
  tiles = {
    ...
    128: {"TileSizes" : [128, 128, 32, 64, 64, 32], "MaxTBsPerSM": 2, "Best-Policy": "Tile-Sync",
      ...
      20480: {"split_ks":  [12,3]},
      25600: {"split_ks":  [12,3]},},
    64: {"TileSizes" : [64, 128, 32, 32, 64, 32], "MaxTBsPerSM": 3, "Best-Policy": "Tile-Sync",
      6144: {"split_ks":   [12,3]},
      8192: {"split_ks":   [12,3]},
      10240: {"split_ks":  [12,3]},
      12288: {"split_ks":  [12,3]},
      ...
      20480: {"split_ks":  [12,3]},
      25600: {"split_ks":  [12,3]}},
    32: {"TileSizes" : [64, 128, 32, 32, 64, 32], "split_ks": [4,1], "MaxTBsPerSM": 3, "Best-Policy": "Tile-Sync",
      6144: {"split_ks":   [12,3]},
      8192: {"split_ks":   [12,3]},
      10240: {"split_ks":  [12,3]},
      12288: {"split_ks":  [12,3]},
    ...
    "MaxTBsPerSM": 3, "Best-Policy": "Tile-Sync",
      ...
      20480: {"split_ks":  [4,1]},
      25600: {"split_ks":  [4,1]}},
    2: {"TileSizes" : [64, 128, 32, 32, 64, 32], "split_ks": [4,1], "MaxTBsPerSM": 3, "Best-Policy": "Tile-Sync",
      6144: {"split_ks":   [4,1]},
      8192: {"split_ks":   [4,1]},
      10240: {"split_ks":  [4,1]},
      12288: {"split_ks":  [4,1]},
      ...
      20480: {"split_ks":  [4,1]},
      25600: {"split_ks":  [4,1]}},
    1: {"TileSizes" : [64, 128, 32, 32, 64, 32], "split_ks": [4,1], "MaxTBsPerSM": 3, "Best-Policy": "Tile-Sync",
      6144: {"split_ks":   [4,1]},
      8192: {"split_ks":   [4,1]},
      10240: {"split_ks":  [4,1]},
      12288: {"split_ks":  [4,1]},
...
for h in [6144, 8192, 12288, 16384]: # , 20480, 25600]: #[10240, 20480, 25600]:
  for m in [256]: #[256, 512, 1024, 2048]: #1,2,4,8,16,32,64,128, 256, 
    if attention_or_mlp == "attention":
    ...
    for syncPolicy in ['Row-Sync', 'Tile-Sync']:
